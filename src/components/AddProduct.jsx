  ...
  return (
    <div className='p-8 box-border bg-white w-full rounded-sm mt-5 lg:ml-5'>
      ...
      <div>
        ...
        <input onChange={imagehandler}type="file" name='image' id='file-input' hidden className='bg-primary max-w-80 w-full py-3 px-4'></input>
      </div>
      <button onClick={() =>{Add_Product()}}className='btn-dark rounded-lg mt-4 flexCenter gap-x1'>Add Product</button>
    </div>
  )
}
